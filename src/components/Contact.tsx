    ...
    <section
      ...
      <form className="space-y-5">
        <input
          ...
          className="h-14 w-full rounded-lg border-2 border-black px-5 text-[15px] outline-none placeholder:text-neutral-500"
        />
        <input
          type="email"
          placeholder="Email"
        ...
        <textarea
          ...
          className="h-40 w-full resize-none rounded-lg border-2 border-black px-5 py-4 text-[15px] outline-none placeholder:text-neutral-500"
        />

        <div className="flex items-center gap-6">
          <button
            type="submit"
            className="h-12 rounded-lg bg-black px-6 text-[17px] font-extrabold text-white">
            Get In Touch
          </button>
      ...
      <div className="pt-2">
        <h3 className="text-[44px] font-black leading-tight md:text-[56px]">
          Let’s{" "}
        ...
        <p className="mt-5 max-w-xl text-[15px] leading-7 text-neutral-500">
          I seek to push the limits of creativity to create high-engaging,
          user-friendly, and memorable interactive experiences.
        </p>

        <div className="mt-8 space-y-2 text-[22px] font-extrabold">
